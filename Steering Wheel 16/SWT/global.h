...
#define RPM_LEDS		16			//75% of ring dedicated to RPM
#define RING_LEDS		16			//17 Neopixel Ring of LEDs
...
int shiftPoints[12] = {8800,9700,8900,9600,9000,10000,9000,10000,9000,10000,9000,10000};
